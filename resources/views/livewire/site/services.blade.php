           ...
           <div class="flex flex-wrap -mx-4">
              <div class="w-full md:w-1/2 lg:w-1/3 px-4" data-aos="fade-up">
                 <div
                    ...
                    <div
                     ...
                     <div class="md:-mt-6" style="font-size: 13px;">
                         <div>
              ...
              <div class="w-full md:w-1/2 lg:w-1/3 px-4" data-aos="fade-up">
                 <div
                    ...
                    <div class="md:mt-3" style="font-size: 13px;">
                         <div>
              ...
              <div class="w-full md:w-1/2 lg:w-1/3 px-4" data-aos="fade-up">
                 ...
                 <div
                    ...
                    <div class="-mt-2" style="font-size: 13px;">
                         <div>
                             • VACANT UNITS <br />
                             • NEW CONSTRUCTION UNITS <br />
                             • SHOWROOMS <br />
                         </div>
                         <div>
                             • MOVE IN/OUT CLEANINGS <br />
                             • STORAGE UNITS <br />
                         </div>
                     </div>
                 </div>
            ...
            <div class="flex flex-wrap -mx-4">
               ...
               <div class="w-full md:w-1/2 lg:w-1/3 px-4" data-aos="fade-up">
                  ...
                  <div
                     ...
                     <div class="md:mt-1" style="font-size: 13px;">
                          <div>
                              • DEEP CLEANING <br />
                              • DISINFECTING <br />
                          </div>
               ...
               <div class="w-full md:w-1/2 lg:w-1/3 px-4" data-aos="fade-up">
                  <div
                     ...
                     <div class="md:-mt-2" style="font-size: 13px;">
                         <div>
                             • DRY WIPING <br />
                             • SCRUBBING <br />
                             • POLISHING <br />
                  ...
                  <div
                     ...
                     <div style="font-size: 13px;">
                         <p>
                             • SPECIAL SERVICES <br />
                             • EVENTS CLEANING <br />
                             • ORGANIZING <br /> (UNDER REQUEST) <br />
                         </p>
                    </div>
                  </div>
               </div>
               <div class="w-full md:w-1/2 px-2" data-aos="fade-up">
                 <div class="p-5 rounded-[20px] bg-white shadow-md hover:shadow-lg mb-8 md:h-40">
                     <h1 class="text-lg lato uppercase text-center">IF THE BUSINESS OR THE SERVICE YOU ARE LOOKING FOR IS NOT LISTED, GET IN
                         TOUCH!</h1>
                     <p class="lato uppercase text-sm mt-5">HAVE A SPECIAL REQUEST? CONTACT US VIA EMAIL AT <span class="text-primary cursor-pointer">INFO@PURESTARTLLC.COM</span>
